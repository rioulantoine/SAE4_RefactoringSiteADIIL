...
<section id="bureau">
    <img src="<?php echo $base; ?>public/assets/photo_bureau_ADIIL.png" alt="Photo de groupe du bureau du BDE 2024" />
...
<section>
    ...
    <div>
        ...
        <img src="<?php echo $base; ?>public/assets/photo_enzo.png" alt="Photo de Enzo Rynders--Vitu" />
    </div>

    <div>
    <img src="<?php echo $base; ?>public/assets/photo_tom.png" alt="Photo de Tom Ysope" />
    ...
    <div>
        ...
        <img src="<?php echo $base; ?>public/assets/photo_mathis.png" alt="Photo de Mathis Le Nôtre" />
    </div>

    <div>
    <img src="<?php echo $base; ?>public/assets/photo_gemino.png" alt="Photo de Gemino Ruffault--Ravenel" />
    ...
    <div class="photo-membres">
        <img src="<?php echo $base; ?>public/assets/photo_axel.png" alt="Photo de Enzo Rynders--Vitu" />
